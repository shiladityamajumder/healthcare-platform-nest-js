...
export class WarehouseListQueryDto {
  ...
  @ApiPropertyOptional({
    description: 'Filter warehouses supporting cold-chain storage.',
    example: true,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Filter warehouses supporting controlled drugs.',
    example: false,
  })
  @IsOptional()
  @Transform(booleanValue)
...
export class WarehouseCreateDto {
  ...
  status = 'active';
  @ApiPropertyOptional({
    description: 'Whether cold-chain inventory is supported.',
    default: false,
  })
  @IsOptional()
  @Transform(booleanValue)
  ...
  @ApiPropertyOptional({
    description: 'Warehouse operating-hours JSON object.',
    example: { monday: { open: '09:00', close: '18:00' } },
  })
  @IsOptional()
  @IsObject()
  operatingHours: Record<string, unknown> | unknown[] = {};
}
...
export class WarehouseUpdateDto {
  @ApiPropertyOptional({
    ...
    example: 'Kolkata Fulfilment Warehouse',
  })
  @IsOptional()
  @IsString()
  @MinLength(1)
...
export class ReplenishmentRuleUpsertDto {
  ...
  variantId?: string;
  @ApiProperty({
    description: 'Minimum quantity before stock is considered low.',
    example: '20.000',
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: 'Quantity suggested when replenishment is triggered.',
    example: '50.000',
  })
  @IsString()
  @IsNotEmpty()
